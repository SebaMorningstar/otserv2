...
local player_positions = {
    [1] = {fromPos = Position(33982, 31072, 10), toPos = Position(33978, 31060, 10)},
    [2] = {fromPos = Position(33981, 31072, 10), toPos = Position(33977, 31060, 10)},
    [3] = {fromPos = Position(33980, 31072, 10), toPos = Position(33976, 31060, 10)},
    [4] = {fromPos = Position(33979, 31072, 10), toPos = Position(33975, 31060, 10)}
}

local monsters = {
    [1] = {pos = Position(33979, 31054, 10), name = "Branchy Crawler"}
}
local quest_range = {fromPos = Position(33971, 31049, 10), toPos = Position(33985, 31060, 10)} -- see image in thread for explanation

local exit_position = Position(33984, 31054, 10) -- Position completely outside the quest area
...
local specs, spec = Game.getSpectators(Position(33919, 31646, 8), false, false, 18, 18, 18, 18)
    for j = 1, #specs do
        spec = specs[j]
        if spec:getName():lower() == 'Branchy Crawler' then
            spec:remove()
        end
    end
end
