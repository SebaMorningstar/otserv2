...
local player_positions = {
    [1] = {fromPos = Position(33774, 31634, 14), toPos = Position(33740, 31627, 14)},
    [2] = {fromPos = Position(33775, 31634, 14), toPos = Position(33741, 31627, 14)},
    [3] = {fromPos = Position(33776, 31634, 14), toPos = Position(33742, 31627, 14)},
    [4] = {fromPos = Position(33777, 31634, 14), toPos = Position(33743, 31627, 14)}
}

local monsters = {
    [1] = {pos = Position(33742, 31632, 14), name = "Goshnar Spite"}
}
local quest_range = {fromPos = Position(33736, 31626, 14), toPos = Position(33748, 31640, 14)} -- see image in thread for explanation

local exit_position = Position(33780, 31633, 14) -- Position completely outside the quest area
