...
local player_positions = {
    [1] = {fromPos = Position(33854, 31854, 6), toPos = Position(33853, 31860, 7)},
    [2] = {fromPos = Position(33855, 31854, 6), toPos = Position(33854, 31860, 7)},
    [3] = {fromPos = Position(33856, 31854, 6), toPos = Position(33855, 31860, 7)},
    [4] = {fromPos = Position(33857, 31854, 6), toPos = Position(33856, 31860, 7)}
}

local monsters = {
    [1] = {pos = Position(33855, 31865, 7), name = "Goshnar Cruelty"}
}
local quest_range = {fromPos = Position(33850, 31859, 7), toPos = Position(33861, 31873, 7)} -- see image in thread for explanation

local exit_position = Position(33858, 31854, 6) -- Position completely outside the quest area
