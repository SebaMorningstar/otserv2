...
local player_positions = {
    [1] = {fromPos = Position(33937, 31218, 11), toPos = Position(33919, 31273, 11)},
    [2] = {fromPos = Position(33937, 31217, 11), toPos = Position(33920, 31273, 11)},
    [3] = {fromPos = Position(33937, 31216, 11), toPos = Position(33921, 31273, 11)},
    [4] = {fromPos = Position(33937, 31215, 11), toPos = Position(33922, 31273, 11)}
}

local monsters = {
    [1] = {pos = Position(33919, 31269, 11), name = "Many faces"}
}
local quest_range = {fromPos = Position(33912, 31262, 11), toPos = Position(33926, 31274, 11)} -- see image in thread for explanation

local exit_position = Position(33911, 31262, 11) -- Position completely outside the quest area
