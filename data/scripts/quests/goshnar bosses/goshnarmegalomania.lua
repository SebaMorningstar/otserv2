...
local player_positions = {
    [1] = {fromPos = Position(33776, 31665, 14), toPos = Position(33745, 31659, 14)},
    [2] = {fromPos = Position(33777, 31665, 14), toPos = Position(33746, 31659, 14)},
    [3] = {fromPos = Position(33778, 31665, 14), toPos = Position(33747, 31659, 14)},
    [4] = {fromPos = Position(33779, 31665, 14), toPos = Position(33748, 31659, 14)}
}

local monsters = {
    [1] = {pos = Position(33746, 31665, 14), name = "Goshnar Megalomania"}
}
local quest_range = {fromPos = Position(33741, 31660, 14), toPos = Position(33753, 31670, 14)} -- see image in thread for explanation

local exit_position = Position(33747, 31673, 14) -- Position completely outside the quest area
