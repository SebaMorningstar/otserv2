...
local player_positions = {
    [1] = {fromPos = Position(33773, 31601, 14), toPos = Position(33741, 31594, 14)},
    [2] = {fromPos = Position(33774, 31601, 14), toPos = Position(33742, 31594, 14)},
    [3] = {fromPos = Position(33775, 31601, 14), toPos = Position(33743, 31594, 14)},
    [4] = {fromPos = Position(33776, 31601, 14), toPos = Position(33744, 31594, 14)}
}

local monsters = {
    [1] = {pos = Position(33741, 31599, 14), name = "Goshnar Hatred"}
}
local quest_range = {fromPos = Position(33738, 31594, 14), toPos = Position(33749, 31605, 14)} -- see image in thread for explanation

local exit_position = Position(33768, 31601, 14) -- Position completely outside the quest area
