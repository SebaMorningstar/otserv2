...
local player_positions = {
    [1] = {fromPos = Position(33485, 31546, 13), toPos = Position(33463, 31532, 13)},
    [2] = {fromPos = Position(33485, 31545, 13), toPos = Position(33463, 31533, 13)},
    [3] = {fromPos = Position(33485, 31544, 13), toPos = Position(33463, 31534, 13)},
    [4] = {fromPos = Position(33485, 31547, 13), toPos = Position(33463, 31535, 13)},
	[5] = {fromPos = Position(33485, 31548, 13), toPos = Position(33463, 31536, 13)},
	[6] = {fromPos = Position(33486, 31544, 13), toPos = Position(33464, 31532, 13)},
	[7] = {fromPos = Position(33486, 31545, 13), toPos = Position(33464, 31533, 13)},
	[8] = {fromPos = Position(33486, 31546, 13), toPos = Position(33464, 31534, 13)},
	[9] = {fromPos = Position(33486, 31547, 13), toPos = Position(33464, 31535, 13)},
	[10] = {fromPos = Position(33486, 31548, 13), toPos = Position(33464, 31536, 13)}
}

local monsters = {
    [1] = {pos = Position(33443, 31546, 13), name = "King Zelos"}
}
local quest_range = {fromPos = Position(33438, 31537, 13), toPos = Position(33452, 31550, 13)} -- see image in thread for explanation

local exit_position = Position(33443, 31555, 13) -- Position completely outside the quest area
