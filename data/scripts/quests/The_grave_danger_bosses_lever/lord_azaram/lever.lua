...
local player_positions = {
    [1] = {fromPos = Position(33422, 31493, 13), toPos = Position(33423, 31477, 13)},
    [2] = {fromPos = Position(33423, 31493, 13), toPos = Position(33424, 31477, 13)},
    [3] = {fromPos = Position(33424, 31493, 13), toPos = Position(33425, 31477, 13)},
    [4] = {fromPos = Position(33425, 31493, 13), toPos = Position(33426, 31477, 13)},
	[5] = {fromPos = Position(33426, 31493, 13), toPos = Position(33427, 31477, 13)}
}

local monsters = {
    [1] = {pos = Position(33424, 31473, 13), name = "Lord Azaram"}
}
local quest_range = {fromPos = Position(33421, 31464, 13), toPos = Position(33432, 31476, 13)} -- see image in thread for explanation

local exit_position = Position(33424, 31464, 13) -- Position completely outside the quest area
