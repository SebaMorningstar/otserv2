...
local player_positions = {
    [1] = {fromPos = Position(33455, 31413, 13), toPos = Position(33454, 31432, 13)},
    [2] = {fromPos = Position(33456, 31413, 13), toPos = Position(33455, 31432, 13)},
    [3] = {fromPos = Position(33457, 31413, 13), toPos = Position(33456, 31432, 13)},
    [4] = {fromPos = Position(33458, 31413, 13), toPos = Position(33457, 31432, 13)},
	[5] = {fromPos = Position(33459, 31413, 13), toPos = Position(33458, 31432, 13)}
}

local monsters = {
    [1] = {pos = Position(33455, 31436, 13), name = "Count Vlarkorth"}
}
local quest_range = {fromPos = Position(33453, 31429, 13), toPos = Position(33464, 31441, 13)} -- see image in thread for explanation

local exit_position = Position(33456, 31446, 13) -- Position completely outside the quest area
