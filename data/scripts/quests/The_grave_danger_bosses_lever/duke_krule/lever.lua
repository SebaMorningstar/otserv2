...
local player_positions = {
    [1] = {fromPos = Position(33455, 31493, 13), toPos = Position(33455, 31478, 13)},
    [2] = {fromPos = Position(33456, 31493, 13), toPos = Position(33456, 31478, 13)},
    [3] = {fromPos = Position(33457, 31493, 13), toPos = Position(33457, 31478, 13)},
    [4] = {fromPos = Position(33458, 31493, 13), toPos = Position(33458, 31478, 13)},
	[5] = {fromPos = Position(33459, 31493, 13), toPos = Position(33459, 31478, 13)}
}

local monsters = {
    [1] = {pos = Position(33456, 31472, 13), name = "Duke Krule"}
}
local quest_range = {fromPos = Position(33453, 31464, 13), toPos = Position(33464, 31476, 13)} -- see image in thread for explanation

local exit_position = Position(33456, 31464, 13) -- Position completely outside the quest area
