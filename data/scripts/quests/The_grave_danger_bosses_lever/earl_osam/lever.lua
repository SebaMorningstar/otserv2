...
local player_positions = {
    [1] = {fromPos = Position(33516, 31444, 13), toPos = Position(33486, 31444, 13)},
    [2] = {fromPos = Position(33517, 31444, 13), toPos = Position(33487, 31444, 13)},
    [3] = {fromPos = Position(33518, 31444, 13), toPos = Position(33488, 31444, 13)},
    [4] = {fromPos = Position(33519, 31444, 13), toPos = Position(33489, 31444, 13)},
	[5] = {fromPos = Position(33520, 31444, 13), toPos = Position(33490, 31444, 13)}
}

local monsters = {
    [1] = {pos = Position(33488, 31439, 13), name = "Earl Osam"}
}
