...
local player_positions = {
    [1] = {fromPos = Position(33424, 31413, 13), toPos = Position(33422, 31433, 13)},
    [2] = {fromPos = Position(33425, 31413, 13), toPos = Position(33423, 31433, 13)},
    [3] = {fromPos = Position(33426, 31413, 13), toPos = Position(33424, 31433, 13)},
    [4] = {fromPos = Position(33427, 31413, 13), toPos = Position(33425, 31433, 13)},
	[5] = {fromPos = Position(33428, 31413, 13), toPos = Position(33426, 31433, 13)}
}

local monsters = {
    [1] = {pos = Position(33424, 31436, 13), name = "Sir Baeloc"},
	[2] = {pos = Position(33424, 31437, 13), name = "Sir Nictros"}
}
local quest_range = {fromPos = Position(33420, 31432, 13), toPos = Position(33433, 31444, 13)} -- see image in thread for explanation

local exit_position = Position(33424, 31449, 13) -- Position completely outside the quest area
