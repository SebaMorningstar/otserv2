...
local player_positions = {
    [1] = {fromPos = Position(33734, 31471, 14), toPos = Position(33709, 31465, 14)},
    [2] = {fromPos = Position(33735, 31471, 14), toPos = Position(33710, 31465, 14)},
    [3] = {fromPos = Position(33736, 31471, 14), toPos = Position(33711, 31465, 14)},
    [4] = {fromPos = Position(33737, 31471, 14), toPos = Position(33712, 31465, 14)}
}

local monsters = {
    [1] = {pos = Position(33711, 31469, 14), name = "The Fear Feaster"}
}
local quest_range = {fromPos = Position(33707, 31464, 14), toPos = Position(33716, 31475, 14)} -- see image in thread for explanation

local exit_position = Position(33712, 31476, 14) -- Position completely outside the quest area
