...
HomeBanners = {
    images = { "home/tibiaupdate2021.jpg" , "home/dandelion_small.jpg" , "home/banner_runemaster.png" },
    delay = 10
}
 ...
 { 
   ...
   offers = { 
        {     
          ...
          price = 750,
          id = 184,
          description = "{character}\n{speedboost}\n\n<i>New Mount from Update 12.66.10876.</i>",
        ...
        },
        {
          ...
          price = 1350,
          id = 186,
          description = "{character}\n{speedboost}\n\n<i>New Mount from update 12.70, Lootable from the boss The Abomination using 4 Fiery Horseshoes!</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
          home = false,
        },
      },
 ...
 -- Base outfit has addon = 0 or no defined addon. By default addon is set to 0.
 {
   ...
   offers = { 
        ...
        },
        {
          ...
          addon = 3,
          description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Fight your bloody battles in the arena and become a darling of the crowd. Once you have made it to the top and everyone is cheering your name, from update 12.70.</i>",
          type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
          home = true,
        },
        {
